...
export default function LoginPage() {
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const serverMsg = error?.response?.data?.detail || "Invalid email or password"
            console.error("Login error:", error?.response?.status, error?.response?.data, "API URL:", process.env.NEXT_PUBLIC_API_URL)
            toast({
                title: "Login failed",
